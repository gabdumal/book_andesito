...
Entre elas, adicionamos uma tarefa de depuração para rodar um programa sem antes compilá-lo (dado que o CMakeTools já fez isso).
O nome dessa tarefa é LLDB: launch C++ project.
