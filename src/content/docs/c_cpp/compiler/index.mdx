...
<Aside type="danger">
  Instalar ferramentas de compilação e depuração de C e C++ para o Windows é mais complicado, instável e carece de boa documentação.
  Algumas funcionalidades precisam de muitas correções obscuras para funcionarem ou nem sequer é possível fazê-las funcionar.
  Recomendamos que você instale alguma distribuição Linux ou o [WSL](../wsl).
</Aside>
