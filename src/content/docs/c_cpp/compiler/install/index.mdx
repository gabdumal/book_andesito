...
Neste capítulo, vamos instalar as ferramentas de compilação para C e C++ para o Fedora, o WSL usando o Fedora e o Mint, além de outros derivados do Debian compatíveis.
