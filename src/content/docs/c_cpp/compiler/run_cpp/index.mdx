...
import compileRunBinary from "@assets/content/docs/c_cpp/compiler/run_cpp/compile_run_binary.png";
...
Também trocamos o nome da tarefa para `Clang: build C++ project (Local)`.
