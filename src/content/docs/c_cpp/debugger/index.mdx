...
Tudo depende da forma como o compilador gera o código objeto e provê informações de depuração.

Isso significa que, para o depurador funcionar, ele deve ser compatível com o compilador que gerou o binário.
...
Se você tiver seguido a sessão de instalação do [**LLVM**](../compiler/install/), o LLDB já deve estar instalado.
