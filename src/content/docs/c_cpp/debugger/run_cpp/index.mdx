...
**Crie** um arquivo chamado `launch.json` dentro da pasta `.vscode` do projeto.
...
Utilize o **snippet** `launch-json` para inicializar o arquivo `launch.json` com o seguinte código:
...
```cpp title="main.cpp" frame="code" startLineNumber=10
tree.insert(3);
```
