...
cd ~/dev/c_cpp_projects/hello_user
```
...
A execução será exibida na aba `Terminal`, que pode ser acessada com o atalho <Kbd linux={"Ctrl+'"} />.

<Figure caption="Execução do programa exibindo o caminho do arquivo executado.">
  <Image
    src={outputOfProgramPath}
    alt={`Aba "Terminal" do Visual Studio Code, em que o programa "hello_user" é executado. Ele exibe no console o seguinte texto: "This is the program /home/gabriel/dev/c_cpp_projects/hello_user/build/hello_user.".`}
  />
</Figure>
...
Se tentarmos executá-lo, veremos a seguinte saída no "Terminal":
...
Agora, se compilarmos e executarmos pelo VScode, o resultado no "Terminal" mostrará o nome "Alice", como a seguir:
