...
import downloadOptionsWindows from "/src/assets/content/docs/rust/download_options_windows.png";
import windowsInstaller from "/src/assets/content/docs/rust/windows_installer.png";
import windowsInstalled from "/src/assets/content/docs/rust/windows_installed.png";
...
Pressione a tecla <Keyboard keys={["1"]} /> e <Keyboard keys={["Enter"]} /> para instalar o Rust e suas ferramentas.
