...
import installingZoxidePowerShell from "/src/assets/content/docs/shell/plugins/installing_zoxide_powershell.png";
import configuringZoxidePowerShell from "/src/assets/content/docs/shell/plugins/configuring_zoxide_powershell.png";
import installingFzfZsh from "/src/assets/content/docs/shell/plugins/installing_fzf_zsh.png";
import installingZoxideZsh from "/src/assets/content/docs/shell/plugins/installing_zoxide_zsh.png";
import checkingZoxideZsh from "/src/assets/content/docs/shell/plugins/checking_zoxide_zsh.png";
import configuringZshPlugins from "/src/assets/content/docs/shell/plugins/configuring_zsh_plugins.png";
...
<Figure
  caption="Instalando o FZF e o Zoxide no PowerShell."
  images={[
    {
      src: installingZoxidePowerShell,
      alt: "Terminal com o PowerShell, em que se executam os comandos para instalar o FZF e o Zoxide.",
    },
  ]}
/>
...
<Figure
  ...
  images={[
    {
      src: configuringZoxidePowerShell,
...
Quando perguntado sobre ativar os recursos do FZF, pressione a tecla <Keyboard keys={["y"]} /> e então pressione <Keyboard keys={["Enter"]} /> para cada.

<Figure
  caption="Instalando o FZF no Zsh."
  images={[
    {
      src: installingFzfZsh,
      alt: "Terminal com o Zsh, em que se executam os comandos para instalar o FZF.",
    },
  ]}
/>
...
<Figure
  caption="Instalando o Zoxide no Zsh."
  images={[
    {
      src: installingZoxideZsh,
      alt: "Terminal com o Zsh, em que se executa o comando para instalar o Zoxide.",
    },
  ]}
/>
...
<Figure
  caption="Verificando as versões do FZF e do Zoxide no Zsh."
  images={[
    {
      src: checkingZoxideZsh,
      alt: "Terminal com o Zsh, em que se verifica as versões do FZF e do Zoxide.",
    },
  ]}
/>
...
<Figure
  caption="Configurando os plugins Zsh Autosuggestions e Zsh Syntax Highlighting."
  images={[
    {
      src: configuringZshPlugins,
      alt: "Arquivo de configuração do Zsh aberto no Visual Studio Code, em que foram adicionadas as configurações dos plugins Zsh Autosuggestions e Zsh Syntax Highlighting.",
    },
  ]}
/>
