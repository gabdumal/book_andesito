...
Para criar um no **Linux** (incluindo o WSL), execute o comando abaixo.

```zsh title="Fedora, WSL ou Mint" frame="terminal"
mkdir -p ~/.config && touch ~/.config/starship.toml
```

Já no **Windows** com o PowerShell, execute os comandos:
...
No **Linux** (incluindo o WSL), execute o comando:

```zsh title="Fedora, WSL ou Mint" frame="terminal"
starship preset nerd-font-symbols -o $STARSHIP_CONFIG
```

Já no **Windows** com o PowerShell, execute o comando:
