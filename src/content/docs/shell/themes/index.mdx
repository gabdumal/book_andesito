...
import fontsSettings from "/src/assets/content/docs/shell/themes/fonts_settings.png";
import settingFontOnWindows from "/src/assets/content/docs/shell/themes/setting_font_on_windows.png";
...
Existe um padrão de fontes chamado [**Nerd Fonts**](https://www.nerdfonts.com/) que é muito utilizado para esse fim.
...
Você pode fazer isso graficamente pelo gerenciador de arquivos.

Se quiser fazer pelo terminal, **abra-o** e **mova-se** para o diretório em que você baixou o arquivo `zip`. Provavelmente foi para a pasta `Downloads`.
...
## Se move para a pasta de fontes e verifica se os aquivos foram copiados
...
<Code code={zshSettings} lang="zsh" title="~/.zshrc" ins={[13, 14, 15]} />
