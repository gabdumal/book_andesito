...
<Figure caption="Instalando o Starship no PowerShell.">
  <Image
...
Sua localização é `$HOME\Documents\PowerShell\Microsoft.PowerShell_profile.ps1`.
...
<Figure caption="Arquivo de configuração do PowerShell com o comando para executar o Starship.">
  <Image
...
Se prompt solicitar sua senha, digite-a e pressione <Kbd linux={"Enter"} />.

<Figure caption="Executando comando de instalação do Starship no Zsh.">
  <Image
    src={starshipOnZsh}
    alt={
...
<Figure caption="Mensagem de sucesso da instalação do Starship no Zsh.">
  <Image
