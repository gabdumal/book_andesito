...
import installOmz from "/src/assets/content/docs/shell/zsh/install_omz.png";
import zshCodeInitial from "/src/assets/content/docs/shell/zsh/zsh_code_initial.png";
import codeTrusted from "/src/assets/content/docs/shell/zsh/code_trusted.png";
