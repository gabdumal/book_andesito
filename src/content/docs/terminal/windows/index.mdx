...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/open_folder.png" />
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/select_terminal.png" />
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/confirm.png" />
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/edit_shortcut.png" />
  <figcaption>Confirmação da criação do atalho na área de trabalho.</figcaption>
</figure>
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/set_keybinding.png" />
  <figcaption>Confirmação da criação do atalho na área de trabalho.</figcaption>
</figure>
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/open_configurations.png" />
  <figcaption>
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/initial_configs.png" />
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/light_theme.png" />
  <figcaption>Tela inicial das configurações do Windows Terminal.</figcaption>
</figure>
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/default_profile.png" />
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/json_file.png" />
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/schemes.png" />
  <figcaption>
...
<figure>
  <img src="/book_dev_env/src/assets/content/docs/terminal/windows/themes.png" />
  <figcaption>
...
<figure>
  <div style="display:flex;align-items:center;gap:1rem;">
    <img
      src="/book_dev_env/src/assets/content/docs/terminal/windows/schemes_list.png"
      style="height:320px;"
    />
    <img
      src="/book_dev_env/src/assets/content/docs/terminal/windows/themes_list.png"
      style="height:320px;"
    />
  </div>
  <figcaption>
