...
Você também pode acessar esse arquivo no [repositório do livro](https://github.com/gabdumal/book_andesito/blob/main/public/settings/vscode/initial/settings.json).

A última opção, `workbench.settings.applyToAllProfiles`, é importante para que as configurações sejam aplicadas a todos os perfis do Visual Studio Code.
